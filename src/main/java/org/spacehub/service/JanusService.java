...
public class JanusService {
  ...
  private final String janusUrl = "http://localhost:8188/janus";
  ...
  public void sendMessage(String sessionId, String handleId, Map<String, Object> body) {
    Map<String, Object> request = Map.of(
            "janus", "message",
            "transaction", UUID.randomUUID().toString(),
            "body", body
  ...
  public void sendMessageWithJsep(String sessionId, String handleId, Map<String, Object> body, Map<String, Object> jsep) {
    Map<String, Object> request = Map.of(
            "janus", "message",
            "transaction", UUID.randomUUID().toString(),
            "body", body,
  ...
  private JsonNode pollForPluginEvent(String sessionId) {
    try {
      for (int i = 0; i < 20; i++) {
        String sessionPollingUrl = String.format("%s/%s?rid=%d&maxev=1", janusUrl, sessionId, System.currentTimeMillis());
        ...
        if (eventNode != null) return eventNode;
        Thread.sleep(300);
      }
